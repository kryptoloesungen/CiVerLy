...
class SAT_SOLVER_CVL(SOLVER_CVL):
    ...
    def solve_multiple(self, model_options, cipher=None, time_limit=None):
        ...
        **Strategy (by-hand blocking with weight escalation)**
        ...
        first_result, _ = self._process_solution_file(solution_file)
        ...
        while solution_index < n:
            ...
            result, w = self._process_solution_file(tmp_sat_file)
    ...
    def solve_multiple(self, model_options, cipher=None, time_limit=None):
        ...
        for i in range(n):
            ...
            if not sol_file.exists():
                ...
                continue
            try:
                results.append(self._process_solution_file(sol_file))
        ...
        if not results and solution_file.exists():
            results.append(self._process_solution_file(solution_file))
