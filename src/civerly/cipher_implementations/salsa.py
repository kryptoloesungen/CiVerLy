...
class Salsa_CVL:
    ...
    def __init__(self, R=8, name=None):
        ...
        EXAMPLES::
            ...
            sage: from civerly.util import int_to_vec, vec_to_int
            sage: from civerly.cipher_implementations.salsa import Salsa_CVL
            sage: salsa_cipher = Salsa_CVL(2)
        ...
        TESTS::
            ...
            ....:     sat_solver=SOLVER.CRYPTOMINISAT,
            ....:     path=Path(tmpdir))
            ....:   salsa_cipher.analyse(model_options=model_options)
